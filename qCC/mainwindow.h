...
public:
	...
	**/
	...
	//! Return stiched image Viewer Class Object
	ccStichedImageViewer* ccGetStichedImageViewer() { return m_ccStichedImageViewer; }

	//Point pickImgId
	void activatePointPickingImg();
	void deactivatePointPickingImg(bool);
...
private:
	...
	**/
	...
	ccStichedImageViewer * m_ccStichedImageViewer;

	ccImageDrawer * m_ccImageDrawer;
	...
	//! 
	ccStichedImageViewer* m_stichedImageViewer;
	//! 
