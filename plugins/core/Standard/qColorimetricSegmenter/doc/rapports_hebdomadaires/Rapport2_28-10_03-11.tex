...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \hline
    Réalisation CdC & Production & ML, TTT, RC & 2 h & En cours &  Continuation de la rédaction du cahier des charges\\
    \hline
    Formation CloudCompare avec le client & Formation & TTT, RC & 1 h 30 & Fait & Renseignements sur les fonctionnalités du logiciel CloudCompare pour la manipulation des nuages de points\\
    \hline
    Recherche sur le projet & Formation & ML, TTT, RC & 1 h 30 & En cours & Recherches sur le langage, le logiciel, les libraries et les nuages de points \\
    \hline
\end{tabularx}
...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \textbf{Tâche} & \textbf{Nature} & \textbf{Qui} & \textbf{Temps} & \textbf{Réalisation} & \textbf{Commentaire} \\
    \hline
    Rendu final du CdC & Production & ML, TTT, RC & X h & 100\% & Rendre la version finalisée du CdC \\
    \hline
