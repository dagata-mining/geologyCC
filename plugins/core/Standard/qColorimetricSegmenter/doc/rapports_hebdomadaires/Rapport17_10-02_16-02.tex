...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \hline
    Rapport d'itération & Production & TT/ RC/ ML & 10 h & Fin & \\
    \hline
    Rapport Système réalisé alpha  & Production & TT/ RC/ ML & 10 h & Fin & \\
    \hline
    Mise au propre du code & Production & TT/ RC/ ML & 3 h & Fin & \\
    \hline
\end{tabularx} \\
...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \textbf{Tâche} & \textbf{Nature} & \textbf{Qui} & \textbf{Temps} & \textbf{Réalisation} & \textbf{Commentaire} \\
    \hline
    Revoir la marge d'erreur filtrage RGB & Production & TT & 5 h & Début & \\
    \hline
    Terminer la nouvelle méthode de segmentation & Production & RC & 5 h & Début & \\
    \hline
    Toon mapping & Production & ML & 5 h & Début & \\
    \hline
\end{tabularx} \\
