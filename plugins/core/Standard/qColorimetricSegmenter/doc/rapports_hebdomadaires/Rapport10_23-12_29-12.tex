...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \hline
    Extraction des points dans un NDP avec PCL & Production & TTT & 10 h & Terminé & Installation de PCL, prise en main de la bibliothèque et réalisation d'un algo pour extraire des points d'un NDP\\
    \hline
\end{tabularx} \\
...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \textbf{Tâche} & \textbf{Nature} & \textbf{Qui} & \textbf{Temps} & \textbf{Réalisation} & \textbf{Commentaire} \\
    \hline
    Installation du projet CloudCompare & Production & TT/ RC/ ML & 5 h & Début & Installer le projet CC et maîtriser l'environnement pour créer notre plugin.\\
    \hline
\end{tabularx} \\
