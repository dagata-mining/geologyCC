...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \hline
    Revoir les plages de l'algo HSV & Production & TT & 2h & Fin & \\
    \hline
    Créer le livrable du plugin & Production & TT & 13h & Fin & Plugin ne fonctionne pas sur les machines du client\\
    \hline
    Tone mapping & Production & ML & 5h & En cours & \\
    \hline
...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \textbf{Tâche} & \textbf{Nature} & \textbf{Qui} & \textbf{Temps} & \textbf{Réalisation} & \textbf{Commentaire} \\
    \hline
    Revoir les champs du filtrage RGB & Prodution & TT & 12h & Fin & \\
    \hline
    Tone mapping & Production & ML & 10h & Fin & \\
    \hline
    Finir nouvel algo de segmentation & Production & RC & 14h & Fin & \\
    \hline
