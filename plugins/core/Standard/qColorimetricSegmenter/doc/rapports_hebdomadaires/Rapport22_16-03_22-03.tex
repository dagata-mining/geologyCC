...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \hline
    Revoir les plages de l'algo HSV & Production & TT & 2h & En cours & \\
    \hline
    Optimisation les conditions algo HSV & Production & TT & 4h & Fin & \\
    \hline
...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \hline
    Créer le livrable du plugin & Production & TT & 5h & Fin & \\
    \hline
...
\hline
    ...
    \end{minipage}
    &
    Les problèmes importants de la semaine : Maladie de Ronan Collier\\
\hline
\end{tabularx}
