...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \hline
    Revoir la structure du plugin & Production & RC & 7 h & Fin & \\
    \hline
    Revoir les algos implémentés & Production & TT/ RC/ ML & 4 h & Fin & \\
    \hline
    Modification UI filtrage RGB & Production & TT & 3 h & Fin & \\
    \hline
    Implémentation Point picking & Production & TT & 15 h & Fin & Difficultés rencontrées pour l'implémentation \\
    \hline
    Réunion client & Discussion & TT/ RC/ ML & 1 h 30  & Fin & Feedback du client et tuteur académique\\
    \hline
\end{tabularx} \\
...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \textbf{Tâche} & \textbf{Nature} & \textbf{Qui} & \textbf{Temps} & \textbf{Réalisation} & \textbf{Commentaire} \\
    \hline
    Préparation rapport d'itération & Production & TT/ RC/ ML & 10 h & Début & \\
    \hline
    Rapport Système réalisé alpha  & Production & TT/ RC/ ML & 10 h & Début & \\
    \hline
    Mise au propre du code & Production & TT/ RC/ ML & 3 h & Début & \\
    \hline
\end{tabularx} \\
